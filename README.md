...
- ![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)  
  Utilizado para desarrollar scripts, automatizar tareas y manejar datos.

- ![Java](https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=java&logoColor=white)  
  Usado en la creación de aplicaciones de escritorio, reforzando conceptos de programación orientada a objetos.
...
- ![JavaFX](https://img.shields.io/badge/JavaFX-0096C9?style=for-the-badge&logo=java&logoColor=white)  
  Framework para crear interfaces gráficas de usuario (GUI) en aplicaciones de escritorio desarrolladas en Java.
...
- ![XML](https://img.shields.io/badge/XML-FF6600?style=for-the-badge&logo=xml&logoColor=white)  
  Lenguaje de marcado usado para estructurar, almacenar e intercambiar datos en formato estructurado.

### 🛠️ Control de versiones y colaboración  
- ![Git](https://img.shields.io/badge/Git-F05032?style=for-the-badge&logo=git&logoColor=white)  
  Herramienta de control de versiones utilizada para gestionar y rastrear cambios en el código fuente.

- ![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)  
  Plataforma de alojamiento de repositorios que permitió trabajar en equipo, compartir proyectos y controlar versiones de forma remota.

### 🐧 Entorno de desarrollo  
- ![Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)  
  Sistema operativo basado en Linux empleado como entorno de desarrollo para compilar, ejecutar y probar aplicaciones.

### 📚 Librerías y APIs  
- `javax.mail`  
  Librería de Java utilizada para el envío de correos electrónicos desde las aplicaciones. Permite gestionar protocolos SMTP, POP3 e IMAP para automatizar notificaciones.

- `MySQL Connector/J`  
  Librería oficial de Java para conectarse a bases de datos MySQL desde aplicaciones Java. Facilita operaciones de consulta, inserción y actualización de datos entre la aplicación y la base de datos.
